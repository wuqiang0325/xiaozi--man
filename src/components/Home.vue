       ...
       <Swiper :swiperSlides="sliders" ></Swiper> 
        <div class="new-home-content">
            ...
            <ul class="home-menu-box" id="home-menu">
                <li><a style="width: 25%;">
                    <router-link to="/cake">
                        <img src="../img/b24fa9c0d277b79493fead122afe8e73.png" alt="蛋糕"> 蛋糕
                    </router-link>
                     </a></li>
                <li><a style="width: 25%;">
                    <img src="../img/8ab874d0a3b69d359f5783357eca8cbb.png" alt="周套餐"> 周套餐 </a></li>
                <li><router-link to="/iceCream" style="width: 25%;">
                    <img src="../img/929c4fc42766b55fac7ba5092b5b9cb9.png" alt="冰淇淋"> 冰淇淋 </router-link></li>
                <li><a style="width: 25%;"> <img src="../img/6d777e1d3aa1681d58ea1640f53e2920.png" alt="企业专区">
                    企业专区 </a></li>
            </ul>
...
<script>
    ...
    import {getSliderImgs,getlistcy,cake} from "../api/index.js";
...
body, div, dl, dt, dd, ul, ol, li, h1, h2, h3, h4, h5, h6, pre, code, form, fieldset, legend, input, button, textarea, p, blockquote, th, td {
    ...
    .new-home-icon {
        display: inline-block;
        vertical-align: middle;
        background: url(../img/new-home-icon.png) no-repeat;
