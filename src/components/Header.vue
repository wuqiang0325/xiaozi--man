    ...
    <div class="header-box" style="height: 0.48rem;">
        <div class="top-header">
            <div class="open-app" hidden="">
                ...
                <img src="../img/app-icon.png" alt="21cake">
            ...
            <div class="title-box">
                ...
                <a href="/" class="header-center">
                    ...
                    <img src="../img/logo.png" class="title-logo" alt="21cake logo">
                ...
                <div class="top-header-menu" :class="{hideIt:flagMenu==false}">
                    <div>
                        <router-link to="/" title="" class="menu-home"><i></i><span>首页</span></router-link>
                        ...
                        <router-link  to="/message-center" class="menu-per"><i class="person"></i><span>个人</span></router-link>
                    </div>
                </div>
            </div>
        </div>
...
<style scoped lang="less">
    ...
    .title-box .top-message {
        background: url(../img/header_message.png) center no-repeat;
        display: inline-block;
    ...
    .top-header-menu a.menu-class i {
        background: url(../img/menu-icon-class.png) no-repeat center top;
        background-size: 0.25*2rem 0.25*2rem;
    }

    .top-header-menu a.menu-per i.person {
        background: url(../img/menu-icon-per.png) no-repeat center top;
        background-size: 0.25*2rem 0.25*2rem;
    }

    .title-box .menuHide i.icon-title {
        background: url(../img/menu-hide.png) no-repeat;
        background-size: cover;
        width: 0.16*2rem;
        height: 0.15*2rem;
    }
                ...
                .home-select-city {
                    ...
                    ul {
                        ...
                        li.active a {
                            ...
                            background: #fff url(../img/icon_selected.png) no-repeat top left;
